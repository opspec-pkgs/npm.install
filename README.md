[![build](https://github.com/opspec-pkgs/npm.install/actions/workflows/build.yml/badge.svg)](https://github.com/opspec-pkgs/npm.install/actions/workflows/build.yml)
