[![Build Status](https://github.com/opspec-pkgs/npm.install/workflows/build/badge.svg?branch=main)](https://github.com/opspec-pkgs/npm.install/actions?query=workflow%3Abuild+branch%3Amain)
